...
{
    public class WillCreateParkingHost : IBehavior<CreateParkingHost, RegistrationWorld>
    {
        public Response<RegistrationWorld> handle(Request<CreateParkingHost, RegistrationWorld> request)
        {
